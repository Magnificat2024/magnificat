...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['qr_code'])) {
        ...
        try {
            ...
            header("Location: http://localhost/website/qr-code-attendance-system/index.php");
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/website/qr-code-attendance-system/index.php';
            </script>
        ";
    }
}
