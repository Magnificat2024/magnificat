...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['student_name'], $_POST['course_section'])) {
        ...
        try {
            ...
            header("Location: http://localhost/website/qr-code-attendance-system/masterlist.php");
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/website/qr-code-attendance-system/masterlist.php';
            </script>
        ";
    }
}
